...
k2=0.199137523054443;
k3=0.049464464957451;
k4=0.290003266207818;
k5=0.084347165512516;
for  i=1:length(C1)
     ...
     if tf(i)>=2/3*tor0
         ...
         timenew(k)=time(i);
         thetabian(k)=dthetanew(k)-(k1+k4)*tor0/3;
         k=k+1;
     end
end
...
%     w9c=(1/N)*Inew(h)^9;
%     w10c=(1/N)*Inew(h)^10;
    k5c=tfnew(h)-2*tor0/3;
    coefficient=[k0c,w1c,w2c,w3c,w4c,w5c,w6c,a1c,a2c,a3c,a4c,b1c,b2c,b3c,b4c,a5c,a6c,b5c,b6c,k5c];
...
for i=1:k-1
    C5new(i,1)=dthetanew(i);
    C5new(i,2)=fsonew(i);
    C5new(i,3)=motornew(i);
    C5new(i,4)=Inew(i);
    C5new(i,5)=tfnew(i);
    C5new(i,6)=timenew(i);
    C5new(i,7)=vlinknew(i);
    C5new(i,8)=0;%alink
    C5new(i,9)=vmotornew(i);
    C5new(i,10)=0;%amotor
    C5new(i,11)=tfcal(i);
    C5new(i,12)=error(i);
    C5new(i,13)=errorrate(i);
end

figure(1);
plot(C5new(1:end,6),C5new(1:end,13),'o');
figure(2);
