...
%     w10c=(1/N)*Inew(h)^10;
    k2c=tfnew(h)+tor0/3;
    coefficient=[k0c,w1c,w2c,w3c,w4c,w5c,w6c,a1c,a2c,a3c,a4c,b1c,b2c,b3c,b4c,a5c,a6c,b5c,b6c,k2c];
...
for i=1:k-1
    C2new(i,1)=dthetanew(i);
    C2new(i,2)=fsonew(i);
    C2new(i,3)=motornew(i);
    C2new(i,4)=Inew(i);
    C2new(i,5)=tfnew(i);
    C2new(i,6)=timenew(i);
    C2new(i,7)=vlinknew(i);
    C2new(i,8)=0;%alink
    C2new(i,9)=vmotornew(i);
    C2new(i,10)=0;%amotor
    C2new(i,11)=tfcal(i);
    C2new(i,12)=error(i);
    C2new(i,13)=errorrate(i);
end

figure(1);
plot(C2new(1:end,6),C2new(1:end,13),'o');
figure(2);
